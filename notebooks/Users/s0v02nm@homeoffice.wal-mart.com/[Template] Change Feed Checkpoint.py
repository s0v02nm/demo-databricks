...
# a function to return a boolean based on whether the last notebook job was successful or not
...
# if last job failed, rollback to the previous clean check point and try writing again
